...
namespace FantasyGame.GamePlay
{
    ...
    public class SmoothOrbitLook : MonoBehaviour, IUpdateable
    {
        ...
        [SerializeField, Range(-360f, 360f)] private float pitchMin;
        [SerializeField, Range(-360f, 360f)] private float pitchMax;
        [SerializeField] private float rotationSmoothTime;
        [SerializeField] private Vector3 startRotationAngle;
